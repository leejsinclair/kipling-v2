export default function FeedbackPanel({ result }) {
  ...
  return (
    <div className="dark:bg-slate-800 rounded-lg shadow-lg p-6 space-y-4">
      <h3 className="text-lg font-semibold text-gray-200 mb-3">Feedback & Tips</h3>
      
      {feedback && feedback.length > 0 && (
        <div className="space-y-2">
          <h4 className="text-sm font-medium text-gray-400">Analysis:</h4>
